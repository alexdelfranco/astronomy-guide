...
<img src="https://upload.wikimedia.org/wikipedia/commons/2/2e/Parallax_Example.png" alt="Parallax Image" width="400"/>
...
Once you are signed in, you will be able to make and save your own graphs! For this activity, we will use a premade graph and make changes to it as we progress. If you are new to Desmos, it might be useful to navigate to their tutorial. For most of what we are doing, you can reference the image below from Desmos' website:

<img src="https://help.desmos.com/hc/article_attachments/4407513097613" alt="Desmos Tutorial" width="600"/>

In this activity, you will interact with a Desmos graph while following the prompts below. You should keep both pages open, switching back and forth between both as necessary. You can begin by opening the Desmos page and coming back here!

### <a href="https://www.desmos.com/calculator/2cjxymdv9u" target="_blank">Click here to access the first Desmos activity!</a>
<iframe src="https://www.desmos.com/calculator/ckziaa8zgt?embed" width="100%vw" height="800" style="border: 1px solid #ccc" frameborder=0></iframe>

### Plotting the Solar System

When you click on the link, you should see a black Desmos graph, with a few dropdown menus on the left panel where equations normally are. You are welcome to look at the equations, but be careful not to make any changes. Any small differences might break the math behind the animations!
...
Once you have answered the questions above, pause $t_{months}$ and click the empyt circle next to the *Stars* folder. Some purple stars have appeared on the plot. Can you find them? They should be to the left of the solar system (around x=15). Zoom out so that both the solar system and the stars are visible at the same time. Now hit the play button next to $t_{months}$.
