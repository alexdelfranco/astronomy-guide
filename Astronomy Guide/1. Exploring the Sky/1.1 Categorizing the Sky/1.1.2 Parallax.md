...
Right above this you should see a black Desmos graph, with a few dropdown menus on the left panel where equations normally are. You are welcome to look at the equations, but be careful not to make any changes. Any small differences might break the math behind the animations!
